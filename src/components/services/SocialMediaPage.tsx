  ...
  return (
    <div className="min-h-screen bg-surface dark:bg-background">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="text-white">
              <Badge className="bg-accent/20 text-accent-strong border-accent-border mb-4">{t("social.badge")}</Badge>
      ...
      <section className="bg-surface-subtle py-20 dark:bg-surface">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="mb-4 text-3xl font-bold text-text-primary md:text-4xl dark:text-slate-100">{t("social.services.heading")}</h2>
          </div>
      ...
      <section className="bg-surface py-20 dark:bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="mb-4 text-3xl font-bold text-text-primary md:text-4xl dark:text-slate-100">{t("social.pricing.heading")}</h2>
          </div>
