...
const translations = {
  ...
  en: {
    ...
    "services.subtitle":
      "We provide complete digital solutions for your success",
    ...
    "services.seo.desc":
      "Improve visibility and win more clients through search",
    "services.social.title": "Social Media Management",
    "services.social.desc":
      "Strategies that build brands and increase engagement",
    ...
    "about.vision.desc":
      "To be the leading digital agency in the region known for creativity and results.",
    "about.values.title": "Our Values",
    "about.values.desc":
      "Transparency, innovation, results and long-term partnerships with clients.",
...
export function LanguageProvider({ children }: { children: ReactNode }) {
  ...
  const t = (key: string): string => {
    return (
      translations[language][key as keyof (typeof translations)["sr"]] || key
    );
  };
