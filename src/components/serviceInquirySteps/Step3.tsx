...
export function Step3({ formData, errors, touched, updateFormData, handleAdditionalServicesChange, handleBlur }: Step3Props) {
  const { t } = useLanguage();
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <Label className="mb-3 block text-bdigital-navy">{t("form.additional_services_label")}</Label>
